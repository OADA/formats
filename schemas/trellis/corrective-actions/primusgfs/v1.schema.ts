...
const schema: Schema = {
  $id:
    'https://formats.openag.io/trellis/corrective-actions/primusgfs/v1.schema.json',
  ...
  examples: [
    {
      ...
      certifying_body: {
        registration_number: 'PAâˆ’PGFSâˆ’000âˆ’0',
      ...
      control_points: {
        '1.01.03': {
          name:
            'Is there an organizational chart of all workers who have food safety related activities?',
          score: {
            preliminary: {
              value: '5',
              units: 'points',
          ...
          corrective_action: {
            ...
            organization_comments:
              'format with corrective actions is attached, as well as the missing positions and the new organization with alternates.',
            decision: {
              value: 'accepted',
              units: 'enum-pgfs-actiondecision',
            },
          },
        },
        '1.03.03': {
          name:
            'Is there a corrective action procedure that describes the requirements for handling deficiencies affecting food safety and prevention of future occurrences?',
          score: {
            preliminary: {
              value: '',
              units: 'points',
        ...
        '1.05.05': {
          name:
            'Is there a documented system for dealing with customer and buyer food safety complaints/feedback along with records and company responses, including corrective actions?',
          score: {
            preliminary: {
              value: '0',
              units: 'points',
          ...
          auditor_comments:
            'MJ.It has a record called "Registering complaints and suggestions".the procedure is missing.',
          files: [],
        },
        '1.06.01': {
          name:
            'Are there current written food safety related specifications for all raw products, ingredients, materials and services purchased?',
          score: {
            preliminary: {
              value: '3',
              units: 'points',
          ...
          auditor_comments:
            'Mn.They have a document called "Accredited providers".service providers and materials are included.Missing specifications calibration providers, consulting and third−party proceedings.Date 20 / Jan / 2016.',
          files: [],
        },
        '1.06.03': {
          ...
          auditor_comments:
            'Mn.They have a document called "Accredited providers".service providers and materials are included.Missing calibration providers, consulting and third−party proceedings.',
          files: [],
        },
        '1.08.02': {
          name:
            'Is there a current list of emergency contact phone numbers for management, law enforcement and appropriate regulatory agencies?',
          score: {
            preliminary: {
              value: '3',
              units: 'points',
          ...
          auditor_comments:
            'Mn.They have emergency telephones, missing regulatory agencies.',
          files: [],
        },
        '2.11.01': {
          ...
          corrective_action: {
            ...
            organization_response:
              'The following Corrective Action has been performed',
            organization_comments:
              'corrective action file is attached.Within the same are the necessary files.the new format gang harvest was created and first internal audit was conducted.',
            decision: {
              value: 'accepted',
              units: 'enum-pgfs-actiondecision',
            },
