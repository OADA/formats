...
exports.default = {
    ...
    description: 'This is the format of an OADA websocket response (server to client)',
    definitions: {
        id: {
    ...
    properties: {
        requestId: {
            description: 'Array of request IDs to which this response pertains. A single string is supported only for legacy purposes.',
            anyOf: [
                {
                    type: 'array',
                    minItems: 1,
